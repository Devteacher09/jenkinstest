...
public class Stream_ex_데이터조작_실습문제2 {
	...
	public static void main(String[] args) {
		...
		//9. 년도별 인원으로 분리하여 Map방식으로 출력하기
		Map<Object,List<Transaction>> groupResult=list.stream().collect(Collectors.groupingBy(Transaction::getYear));
		System.out.println(groupResult);
		for(Object year : groupResult.keySet()) {
			System.out.println(year);
			for(Transaction t : groupResult.get(year)) {
