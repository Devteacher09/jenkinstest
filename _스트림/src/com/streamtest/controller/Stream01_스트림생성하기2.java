...
public class Stream01_스트림생성하기2 {
...
//		System.out.println(result);
		...
		Arrays.stream(data).filter(s->s.length()>4).forEach(System.out::println);	
		...
		System.out.println("===== iterate메소드 이용하기 =====");
		...
		//       그이후에는 이전 로직에서 반환된 값을 인수로 넣어줌. reduce와 동일한 기능
		...
		//Pattern클래스를 이용해서 파싱해서 처리할 수 있다.
