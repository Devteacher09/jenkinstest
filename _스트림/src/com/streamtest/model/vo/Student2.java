...
public class Student2 {
	...
	public Student2(String name, int age, Gender gender, int grade, String address) {
		super();
		this.name = name;
		this.age = age;
		this.gender = gender;
...
//		}
	...
	public Student2 clone() {
		return new Student2.Builder().name(name).age(age).address(address).gender(gender).grade(grade).stdNo(stdNo).build();
	}
